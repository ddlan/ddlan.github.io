    ...
    return (
      <div>
        ...
        <div className="container-fluid project-page">
          ...
          <div class ="link-area">
            <a type="button" class="btn btn-default btn-lg" href="https://github.com/brucejh99/inCite">
              View on GitHub <img width={50} height={50} alt="GitHub" src={require("../../../Assets/img/github logo.png")} />
            </a>
            <a type="button" href="https://chrome.google.com/webstore/detail/incite/hdobehekolhhcajgmhpbfjomdncnbkck?utm_source=chrome-ntp-icon">
              <img height={72} alt="App Store" src={require("../../../Assets/img/chromewebstoreblack.png")} />
            </a>
          </div>
        </div>
      </div>
